...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default=".",
        help="Folder containing output_run4, output_run5, output_run6",
    )
    parser.add_argument(
        "--runs",
        nargs="+",
        default=["output_run4", "output_run5", "output_run6"],
        help="Run folders",
    )
    parser.add_argument(
        "--max-time",
    ...
    final_pdf = root / "goalexplorer_runs.pdf"
    ...
    plt.title("Average Coverage from GoalExplorer (3 runs)")
