...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default=".",
        help="Folder containing output_run7, output_run8, output_run9",
    )
    parser.add_argument(
        "--runs",
        nargs="+",
        default=["output_run7", "output_run8", "output_run9"],
        help="Run folders",
    )
    parser.add_argument(
        "--max-time",
    ...
    final_pdf = root / "guardian_runs.pdf"
    ...
    plt.title("Average Coverage from Guardian (3 runs)")
